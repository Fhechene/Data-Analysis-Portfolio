...
declare @MaxDateInDW int --MAX(DISTINCT CalendarYear) from [AdventureWorksDW2019].[dbo].[DimDate] group by CalendarYear--select top(1) CalendarYear from [AdventureWorksDW2019].[dbo].[DimDate] order by CalendarYear desc

set @MaxDateInDW =(SELECT Top(1) CalendarYear from [AdventureWorksDW2019].[dbo].[DimDate] order by CalendarYear desc )
--select @MaxDateInDW  =  TOP(1) MAX(CalendarYear) from [AdventureWorksDW2019].[dbo].[DimDate] order by CalendarYear --having CalendarYear=MAX(CalendarYear)-- from [AdventureWorksDW2019].[dbo].[DimDate]

declare @YearsToAdd int = @CurrentYear - @MaxDateInDW 
--select @MaxDateInDW as max dw year
...
delete from [AdventureWorksDW2019].[dbo].FactCurrencyRate where month([Date]) = 2 and day([Date]) = 29
delete from [AdventureWorksDW2019].[dbo].FactProductInventory  where month([MovementDate]) = 2 and day([MovementDate]) = 29


-- Drop foreign keys 
--if FactCurrencyRate.CONSTRAINT_TYPE = 'PRIMARY KEY'
if exists (SELECT TABLE_NAME,
       CONSTRAINT_TYPE,CONSTRAINT_NAME
FROM INFORMATION_SCHEMA.TABLE_CONSTRAINTS
WHERE TABLE_NAME='FactCurrencyRate' and CONSTRAINT_TYPE='FOREIGN KEY'and 'FK_FactCurrencyRate_DimDate'=CONSTRAINT_NAME) 
begin
...
if exists (SELECT TABLE_NAME,
       CONSTRAINT_TYPE,CONSTRAINT_NAME
FROM INFORMATION_SCHEMA.TABLE_CONSTRAINTS
WHERE TABLE_NAME='FactFinance' and CONSTRAINT_TYPE='FOREIGN KEY'and 'FK_FactFinance_DimDate'=CONSTRAINT_NAME) 
begin
...
if exists (SELECT TABLE_NAME,
       CONSTRAINT_TYPE,CONSTRAINT_NAME
FROM INFORMATION_SCHEMA.TABLE_CONSTRAINTS
WHERE TABLE_NAME='FactInternetSales' and CONSTRAINT_TYPE='FOREIGN KEY'and 'FK_FactInternetSales_DimDate'=CONSTRAINT_NAME) 
begin
...
if exists (SELECT TABLE_NAME,
       CONSTRAINT_TYPE,CONSTRAINT_NAME
FROM INFORMATION_SCHEMA.TABLE_CONSTRAINTS
WHERE TABLE_NAME='FactInternetSales' and CONSTRAINT_TYPE='FOREIGN KEY'and 'FK_FactInternetSales_DimDate1 '=CONSTRAINT_NAME) 
begin
...
if exists (SELECT TABLE_NAME,
       CONSTRAINT_TYPE,CONSTRAINT_NAME
FROM INFORMATION_SCHEMA.TABLE_CONSTRAINTS
WHERE TABLE_NAME='FactInternetSales' and CONSTRAINT_TYPE='FOREIGN KEY'and 'FK_FactInternetSales_DimDate2'=CONSTRAINT_NAME) 
begin
...
if exists (SELECT TABLE_NAME,
       CONSTRAINT_TYPE,CONSTRAINT_NAME
FROM INFORMATION_SCHEMA.TABLE_CONSTRAINTS
WHERE TABLE_NAME='FactProductInventory' and CONSTRAINT_TYPE='FOREIGN KEY'and 'FK_FactProductInventory_DimDate'=CONSTRAINT_NAME) 
begin
...
if exists (SELECT TABLE_NAME,
       CONSTRAINT_TYPE,CONSTRAINT_NAME
FROM INFORMATION_SCHEMA.TABLE_CONSTRAINTS
WHERE TABLE_NAME='FactResellerSales' and CONSTRAINT_TYPE='FOREIGN KEY'and 'FK_FactResellerSales_DimDate '=CONSTRAINT_NAME) 
begin
...
if exists (SELECT TABLE_NAME,
       CONSTRAINT_TYPE,CONSTRAINT_NAME
FROM INFORMATION_SCHEMA.TABLE_CONSTRAINTS
WHERE TABLE_NAME='FactSurveyResponse' and CONSTRAINT_TYPE='FOREIGN KEY'and 'FK_FactSurveyResponse_DateKey '=CONSTRAINT_NAME) 
begin
...
DECLARE @startdate DATE = DATEFROMPARTS(YEAR(GETDATE())-4, 1, 1)--YEAR(GETDATE())-4 --'2015-01-01' --change start date if required 
...
--select EnglishDayNameOfWeek,SpanishDayNameOfWeek from [AdventureWorksDW2019].[dbo].[dimdate] where SpanishDayNameOfWeek ='Lunes'
--select distinct CalendarYear from DimDate order by CalendarYear asc